...
HtmlParser.prototype.parseElement = function () {
    ...
    var element = new Dom.ElementNode(tagName, attributes, children)

    if (element.tagName === 'style') {
        this.styleTags.push(element);
    }
...
HtmlParser.prototype.parse = function () {
    ...
    var rootNode = nodes.length === 1 ?
        nodes[0] :
        new Dom.ElementNode('html', null, nodes);

    return new Dom.Document(rootNode, this.styleTags);
};
